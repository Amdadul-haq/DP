...
// app/api/prescriptions/[id]/pdf/route.ts eita kintu kaj krche but vercel e pdf generation korle bangla fonts er problem hocche tai ekta notun approach try krci
// import { NextRequest, NextResponse } from "next/server";
// import { verifyJWT } from "@/lib/auth";
// import { generatePrescriptionHTML } from "@/app/utils/prescription-template";
